...
namespace pointcloud {
	...
	namespace shape {
		...
		class HorizontalPlane : public CGAL::Shape_detection_3::Shape_base<Traits> {
		public:
		...
		public:
			HorizontalPlane() : CGAL::Shape_detection_3::Shape_base<Traits>() {}
		...
		protected:			virtual void create_shape(const std::vector<std::size_t> &indices) {
				...
				Vector_3 l_v = this->normal(indices[0]);
